/*
* This is the User model for our current project.
* We're using LevelDB for the database which is extremely customizable and top level.
* It requires that I write all of the basic model functions from scratch
* I'm following the 'skinny controller - fat model' approach.
*/
